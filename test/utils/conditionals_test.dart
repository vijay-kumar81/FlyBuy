...
void main() {
  ...
  group('conditionalCheck', () {
    test('Test conditionals should return truly', () {
      ...
      expect(
          conditionalCheck(
              conditional, conditionals, variableKeys, getVariable),
          true);
      ...
      expect(
          conditionalCheck(
              conditional, conditionals2, variableKeys, getVariable),
          true);
      ...
      expect(
          conditionalCheck(
              conditional, conditionals3, variableKeys, getVariable),
          true);
      ...
      expect(
          conditionalCheck(
              conditional, conditionals4, variableKeys, getVariable),
          true);
      ...
      expect(
          conditionalCheck(
              conditional, conditionals5, variableKeys, getVariable),
          true);
    });
