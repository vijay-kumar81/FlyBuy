...
import 'package:flybuy/utils/video_parser_url.dart';
...
void main() {
  ...
  group('VideoParserUrl - getYoutubeId', () {
    test(
        'It should be return ID in url format https://www.youtube.com/watch?v=S5aK3TIOnIw',
        () {
      expect(
          VideoParserUrl.getYoutubeId(
              'https://www.youtube.com/watch?v=S5aK3TIOnIw'),
          'S5aK3TIOnIw');
    });
    test('It should be return ID in url format https://youtu.be/S5aK3TIOnIw',
        () {
      expect(VideoParserUrl.getYoutubeId('https://youtu.be/S5aK3TIOnIw'),
          'S5aK3TIOnIw');
    });
    test('It should be return null with not validate URL', () {
      expect(
          VideoParserUrl.getYoutubeId('youtube.com/watch?v/S5aK3TIOnIw'), null);
    });
    test('It should be return null with not validate URL', () {
