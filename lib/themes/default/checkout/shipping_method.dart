...
class ShippingMethod extends StatelessWidget {
  ...
  const ShippingMethod({Key? key, this.padHorizontal = layoutPadding})
      : super(key: key);
      ...
      children: [
        ...
        Padding(
          padding: EdgeInsets.fromLTRB(
              padHorizontal, itemPaddingMedium, padHorizontal, 0),
          child: const TotalView(
              title: 'Door Bumper ×1',
              price: '\$190.00',
              type: TotalType.containerPrice),
        ),
      ],
    );
  }
