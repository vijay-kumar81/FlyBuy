          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                Padding(
                  padding:
                      EdgeInsets.fromLTRB(padHorizontal, 0, padHorizontal, 8),
                  child: Text(translate('checkout_payment_method'),
        ...
        children: [
          ...
          InkWell(
            ...
            child: Row(
              ...
              children: [
                Text(translate('checkout_billing_address'),
                    style: theme.textTheme.titleLarge),
                Text(
          ...
          Text('123 Khuat Duy Tien, Ha Noi, 100000, VietNam',
