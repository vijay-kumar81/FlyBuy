...
class FlybuyPostAuthorItem extends StatelessWidget
    with PostAuthorMixin, Utility {
  ...
  void navigate(BuildContext context) {
    ...
    Navigator.of(context).pushNamed(PostAuthorScreen.routeName,
        arguments: {'author': postAuthor});
  }
      ...
      case Strings.postAuthorItemContained:
        return LayoutBuilder(
          builder: (_, BoxConstraints constraints) {
            double defaultWidthItem = constraints.maxWidth != double.infinity
