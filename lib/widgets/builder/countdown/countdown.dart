...
class _CountdownWidgetState extends State<CountdownWidget>
  ...
  Widget build(BuildContext context) {
    ...
    String textTitle =
        ConvertData.textFromConfigs(fields["title"], settingStore.languageKey);
    TextStyle textStyle =
        ConvertData.toTextStyle(get(fields, ['title'], {}), themeModeKey);
  ...
  Widget buildLayout(String layout,
      {double? pad, String? alignment, Widget? label, Widget? time}) {
    switch (layout) {
      case 'vertical':
        return Vertical(
          label: label,
  ...
  Widget buildTime({
    ...
    Color background = ConvertData.fromRGBA(
        get(styles, ['backgroundTime', themeModeKey], {}), theme.primaryColor);
    Color borderTime = ConvertData.fromRGBA(
        get(styles, ['borderTime', themeModeKey], {}), theme.primaryColor);
    Color textColor = ConvertData.fromRGBA(
        get(styles, ['textColor', themeModeKey], {}), Colors.white);
    Color separatorColor = ConvertData.fromRGBA(
        get(styles, ['separatorColor', themeModeKey], {}), theme.dividerColor);
    ...
    return TimeCount.itemTime(
      ...
      textStyle: theme.textTheme.titleSmall
          ?.copyWith(color: textColor, fontFamily: "digital7"),
