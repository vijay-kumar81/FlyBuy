...
class _InformationVideoShopState extends State<InformationVideoShop> {
  ...
  void initState() {
    if (widget.videoDescription != null &&
        widget.videoDescription!.removeHtmlTag.length >
            limitedViewingDescription) {
      _showReadMore = true;
    }
      ...
      child: Column(
        ...
        children: <Widget>[
          if (widget.videoTitle != null &&
              widget.videoTitle!.removeHtmlTag.isNotEmpty)
            Padding(
          ...
          if (widget.videoDescription != null &&
              widget.videoDescription!.removeHtmlTag.isNotEmpty)
            (_showReadMore)
                ? (_expandDescription)
                    ? GestureDetector(
                        onTap: () {
