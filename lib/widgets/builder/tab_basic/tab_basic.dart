...
class _TabBasicWidgetState extends State<TabBasicWidget>
    with Utility, ContainerMixin, TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    double contentHeight =
        ConvertData.stringToDouble(get(styles, ['contentHeight'], 300));
    Color tabColor = ConvertData.fromRGBA(
        get(styles, ['tabColor', themeModeKey], {}),
        theme.colorScheme.onSurface);
    Color selectTabColor = ConvertData.fromRGBA(
        get(styles, ['selectTabColor', themeModeKey], {}), theme.primaryColor);
    Color contentTextColor = ConvertData.fromRGBA(
        get(styles, ['contentTextColor', themeModeKey], {}),
          ...
          Theme(
            ...
            child: TabBar(
              ...
              tabs: List.generate(
                ...
                (inx) {
                  String name =
                      get(items[inx], ['data', 'title', languageKey], 'item');
                  return Container(
                    height: 33,
          ...
          SizedBox(
            ...
            child: TabBarView(
              ...
              children: List.generate(
                ...
                (index) {
                  String text =
                      get(items[index], ['data', 'content', languageKey], '');
