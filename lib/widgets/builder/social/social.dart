      ...
      child: Wrap(
        ...
        children: List.generate(items.length, (index) {
          ...
          Color colorIcon = ConvertData.fromRGBA(
              ...
              theme.primaryColor);
          String url = ConvertData.textFromConfigs(
              get(item, ['data', 'linkSocial']), languageKey);
          bool enableRound = get(item, ['data', 'enableRound'], false);
          bool enableOutLine = get(item, ['data', 'enableOutLine'], true);

          SocialType typeButton =
              enableRound ? SocialType.circle : SocialType.square;
          return FlybuyButtonSocial(
