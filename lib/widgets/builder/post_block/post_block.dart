...
class _PostBlockWidgetState extends State<PostBlockWidget>
    with Utility, LoadingMixin, ContainerMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: _post != null && _post!.blocks!.isNotEmpty
          ? Column(
              children: List.generate(_post!.blocks!.length,
                  (index) => PostBlock(block: _post!.blocks!.elementAt(index))),
            )
          : _loading
