...
class VendorWidget extends StatelessWidget with Utility, ContainerMixin {
  ...
  Widget build(BuildContext context) {
    ...
    EdgeInsetsDirectional margin =
        ConvertData.space(get(styles, ['margin'], {}), 'margin');
    ...
    double? widthItem =
        ConvertData.stringToDouble(get(styles, ['widthItem'], 250), 250);
    ...
    String? template =
        get(fields, ['template', 'template'], Strings.vendorItemContained);
