...
class _ProductRecentlyState extends State<ProductRecentlyWidget>
  ...
  void didChangeDependencies() {
    ...
    _productRecentlyStore =
        Provider.of<AuthStore>(context).productRecentlyStore;
    ...
    List<Product> product = _productRecentlyStore!.data
        .map((String id) => Product(id: ConvertData.stringToInt(id)))
        .toList();
