...
class _PostListWidgetState extends State<PostListWidget>
  ...
  void didChangeDependencies() {
    ...
    int perPage =
        ConvertData.stringToInt(get(widget.fields, ['perPage'], '10'));
    ...
    List<PostCategory> catsObj = categories
        ...
        .toList();
    List<Post> includePostObj =
        post.map((t) => Post(id: ConvertData.stringToInt(t['key']))).toList();
    ...
    return Observer(
      builder: (_) {
        ...
        double? height = ConvertData.stringToDoubleCanBeNull(
            get(widget.styles, ['height'], 300));

        // Item template
        String? layout =
            get(widget.fields, ['layoutItem'], Strings.postLayoutList);
        ...
        return SizedBox(
          height: layout == Strings.postLayoutCarousel ||
                  layout == Strings.postLayoutSlideshow
