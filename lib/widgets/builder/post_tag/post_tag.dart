...
class _PostTagWidgetState extends State<PostTagWidget>
  ...
  void didChangeDependencies() {
    ...
    if (widget.widgetConfig != null &&
        _appStore.getStoreByKey('${widget.widgetConfig!.id}_$limit') == null) {
      ...
      _postTagStore =
          _appStore.getStoreByKey('${widget.widgetConfig!.id}_$limit');
    }
  ...
  Widget build(BuildContext context) {
    ...
    double? borderRadius =
        ConvertData.stringToDouble(get(fields, ['borderRadius'], '5'));

    // Item
    Color itemColor = ConvertData.fromRGBA(
        get(styles, ['itemColor', themeModeKey], {}), Colors.black);
    Color itemBackground = ConvertData.fromRGBA(
        get(styles, ['itemBackground', themeModeKey], {}), Colors.transparent);
    Color itemBorderColor = ConvertData.fromRGBA(
        get(styles, ['itemBorderColor', themeModeKey], {}), theme.dividerColor);
