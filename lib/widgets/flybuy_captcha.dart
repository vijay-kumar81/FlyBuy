...
class _FlybuyCaptchaForm extends StatefulWidget {
  final void Function(String captcha, String phrase) submit;

  const _FlybuyCaptchaForm({
    Key? key,
    required this.submit,
  }) : super(key: key);

  @override
  State<_FlybuyCaptchaForm> createState() => _FlybuyCaptchaFormState();
}

class _FlybuyCaptchaFormState extends State<_FlybuyCaptchaForm>
    with Utility, LoadingMixin {
  ...
  void validateCaptcha(RequestHelper requestHelper, Map<String, dynamic> data,
      ...
      child: Column(
        ...
        children: [
          if (_error?.isNotEmpty == true) ...[
            Text(_error!,
                style:
                    theme.textTheme.bodySmall?.copyWith(color: ColorBlock.red)),
            ...
            children: [
              ...
              InkResponse(
                ...
                child: Icon(Icons.sync,
                    color: _loading ? theme.dividerColor : theme.primaryColor),
              )
            ],
          ),
