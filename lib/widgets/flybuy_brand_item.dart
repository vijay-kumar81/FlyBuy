...
class FlybuyBrandItem extends StatelessWidget with BrandMixin, Utility {
  final Brand? brand;
  ...
  Widget buildItem(BuildContext context, {required double maxWidth}) {
    ...
    BoxFit fit =
        ConvertData.toBoxFit(get(templateData, ['imageSize'], 'cover'));
    ...
    switch (templateType) {
      ...
      case Strings.brandItemWrap:
        ...
        double? heightView = heightDefaultItem != null
            ? heightDefaultItem - defaultPadding.vertical
            : null;
      ...
      case Strings.brandItemHorizontal:
        ...
        double widthImage = heightDefaultItem == null
            ? widthDefaultItem < 92 && widthDefaultItem > 0
                ? widthDefaultItem
                : 92
            : heightDefaultItem < widthDefaultItem &&
                    heightDefaultItem < 92 &&
                    heightDefaultItem > 0
                ? heightDefaultItem
                : 92;
        double heightImage = widthImage;
      ...
      default:
        EdgeInsetsGeometry defaultPadding =
            padding ?? paddingHorizontalTiny.add(paddingVerticalMedium);
        ...
        double widthImage = widthDefaultItem - defaultPadding.horizontal > 0
            ...
            : widthDefaultItem;
        double heightImage = heightDefaultItem != null
            ? double.infinity
            : (widthImage * 46) / 90;
