...
class _PostWishlistScreenState extends State<PostWishlistScreen>
    with NavigationMixin, LoadingMixin {
  ...
  void didChangeDependencies() {
    ...
    List<Post> postWishList = _postWishListStore!.data
        .map((String id) => Post(id: int.parse(id)))
        .toList();
  ...
  void dismissItem(
    ...
    final snackBar = SnackBar(
      content: Text(AppLocalizations.of(context)!.translate(
          'post_wishlist_notification_deleted', {'name': post.postTitle})),
  ...
  Widget build(BuildContext context) {
    ...
    return Observer(builder: (_) {
      ...
      WidgetConfig? widgetConfig =
          data != null ? data.widgets!['postWishlistPage'] : null;
      ...
      double? labelRadius =
          ConvertData.stringToDouble(get(styles, ['labelRadius'], 19), 19);
      double? radiusImage =
          ConvertData.stringToDouble(get(styles, ['radiusImage'], 8), 8);
                  ...
                  (index) {
                    ...
                    return DismissibleItem(
                      ...
                      onDismissed: (direction) =>
                          dismissItem(context, index, direction, post),
  ...
  Widget _buildAppbar(BuildContext context, {bool centerTitle = true}) {
    ...
    String textTranslate =
        count > 1 ? 'post_wishlist_items' : 'post_wishlist_item';
