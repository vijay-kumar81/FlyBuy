...
import 'package:flybuy/screens/location/search_location.dart';
import 'package:flybuy/screens/location/widgets/looking_location.dart';
...
class _AllowLocationScreenState extends State<AllowLocationScreen>
  ...
  void _openAppSettings() async {
    ...
    if (isWeb && mounted && permission == LocationPermission.deniedForever) {
      showError(
          context, translate('search_guide', {'appName': Strings.appName}));
      return;
    }
                      ...
                      onPressed: () async {
                        ...
                        if (result != null) {
                          ...
                          Place place = await GooglePlaceApiHelper()
                              .getPlaceDetailFromId(queryParameters: {
                            'place_id': result.placeId,
                          });
                          await _locationStore.setLocation(
                              location: place.toUserLocation());
    ...
    return Center(
      child: Padding(
        ...
        child: NotificationScreen(
          title: Text(translate('search_you_are_turning_off_location_access'),
