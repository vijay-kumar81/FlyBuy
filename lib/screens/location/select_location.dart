...
class _SelectLocationScreenState extends State<SelectLocationScreen>
  ...
  final ValueNotifier<UserLocation> _position =
      ValueNotifier<UserLocation>(UserLocation(
    lat: initLat,
    lng: initLng,
                  ...
                  ? Expanded(
                      child: SingleChildScrollView(
                        ...
                        child: ValueListenableBuilder<UserLocation>(
                          valueListenable: _position,
                          builder: (_, value, __) =>
                              SelectNearByLocation(location: value),
                        ),
                      ),
                    )
          ...
          const Positioned(
            ...
            child: Center(
              child: Icon(FontAwesomeIcons.mapMarkerAlt,
                  size: 30, color: ColorBlock.redBase),
            ),
          ),
  ...
  Widget _buildMap() {
    return GoogleMap(
      ...
      initialCameraPosition: CameraPosition(
        target: LatLng(
            _position.value.lat ?? initLat, _position.value.lng ?? initLng),
        zoom: initZoom,
      ),
