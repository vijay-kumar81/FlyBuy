...
class _FormAddressScreenState extends State<FormAddressScreen>
  ...
  Widget buildAddress(ThemeData theme) {
    String text = _location.address is String && _location.address!.isNotEmpty
        ? _location.address!
        : 'Add address';
  ...
  bool checkSave() {
    if (_typeScreen == 'add') {
      if (_location.address is String &&
          _location.lat is double &&
          _location.lng is double) {
        return true;
      }
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: baseStyleAppBar(
        context,
        title: _typeScreen == 'edit'
            ? translate('form_location_edit_txt')
            : translate('form_location_add_txt'),
        ...
        children: [
                                ...
                                return Padding(
                                  ...
                                  child: ButtonSelect.filter(
                                    padding: const EdgeInsets.symmetric(
                                        horizontal: 28, vertical: itemPadding),
                                    ...
                                    onTap: () {
                                      if (index != _visitType) {
                                        bool enableType =
                                            _location.tag != 'office' &&
                                                _location.tag != 'home';
                                        String valueType = getTypeText(index,
                                            '${enableType ? _location.tag : ''}');
          ...
          Container(
            ...
            decoration: BoxDecoration(
                color: theme.scaffoldBackgroundColor, boxShadow: initBoxShadow),
            child: SizedBox(
              height: 48,
