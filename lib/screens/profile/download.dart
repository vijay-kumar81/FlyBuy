...
class _DownloadScreenState extends State<DownloadScreen>
  ...
  void _onScroll() {
    if (!_controller.hasClients ||
        _downloadStore!.loading ||
        !_downloadStore!.canLoadMore) return;
  ...
  Widget build(BuildContext context) {
    ...
    return Observer(builder: (_) {
      ...
      List<Download> emptyDownloads =
          List.generate(_downloadStore!.perPage, (index) => Download());
        ...
        body: CustomScrollView(
          ...
          slivers: [
            ...
            if (downloads.isEmpty)
              SliverFillRemaining(child: Center(child: _buildOrderEmpty())),
          ],
        ),
      );
    });
