...
class _AddressFieldCountryState extends State<AddressFieldCountry>
    with Utility {
  ...
  void didUpdateWidget(covariant AddressFieldCountry oldWidget) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (oldWidget.value != widget.value &&
          _getName(widget.value ?? "", widget.countries) != _controller.text) {
        getText();
      }
    });
  ...
  _onChanged() {
    String defaultValue = get(widget.field, ['default'], '');
    if (_controller.text !=
        _getName(widget.value ?? defaultValue, widget.countries)) {
            ...
            return buildViewModal(
              ...
              child: ModalCountryAddress(
                ...
                onChange: (String? countryValue) =>
                    Navigator.pop(context, countryValue),
