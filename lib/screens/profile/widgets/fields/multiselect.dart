...
class AddressFieldMultiSelect extends StatefulWidget {
  ...
  @override
  State<AddressFieldMultiSelect> createState() =>
      _AddressFieldMultiSelectState();
}

class _AddressFieldMultiSelectState extends State<AddressFieldMultiSelect>
    with Utility {
      ...
      children: List.generate(data.length, (index) {
        ...
        return SizedBox(
          ...
          child: ElevatedButton(
            ...
            style:
                ElevatedButton.styleFrom(textStyle: theme.textTheme.bodySmall),
            child: Row(
      ...
      children: [
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            ...
            child: Text(
                AppLocalizations.of(context)!.translate('edit_account_save')),
          ),
        )
      ],
    );
