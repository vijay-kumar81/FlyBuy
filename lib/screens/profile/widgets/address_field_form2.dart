...
class _AddressFieldForm2 extends State<AddressFieldForm2> with Utility {
  ...
  Map<String, dynamic> getFields(
      Map<String, dynamic> defaultData, Map<String, dynamic>? addData) {
    ...
    data.removeWhere((key, value) =>
        value['hidden'] == true ||
        (widget.hideFields != null && widget.hideFields!.contains(key)));
    ...
    Map<String, dynamic> sortedMap = LinkedHashMap.fromIterable(sortedKeys,
  ...
  FormFieldValidator<String>? validatorInput(
      String key, bool requiredInput, TranslateType translate) {
    if (requiredInput) {
      return (String? value) {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.addressFields == null ||
        get(widget.addressFields, ['default'], null) == null) {
      return Container();
    }
    ...
    Map<String, dynamic> defaultFields =
        get(widget.addressFields, ['default'], null);

    Map<String, dynamic>? addFields =
        get(widget.addressFields, [countryId], null);
    Map<String, dynamic> fields = getFields(defaultFields, addFields);

    CountryData? countrySelect = widget.countries
        .firstWhereOrNull((element) => element.code == countryId);

    List<Map<String, dynamic>> states =
        countrySelect is CountryData ? countrySelect.states! : [];
    Map<String, dynamic>? stateSelect =
        states.firstWhereOrNull((element) => element['code'] == stateId);
    _txtCountry.text = countrySelect is CountryData ? countrySelect.name! : '';
    _txtState.text =
        stateSelect is Map<String, dynamic> ? stateSelect['name'] : '';
      ...
      child: Column(
        ...
        children: [
          ...
          ...List.generate(fields.keys.length, (index) {
            ...
            String? label =
                get(field, ['label'], transLabel(keyField, translate));
            ...
            if (type == 'country') {
              return Padding(
                ...
                child: AddressFieldCountry(
                  ...
                  validator:
                      validatorInput(keyField, requiredInput!, translate),
              ...
              return Padding(
                ...
                child: AddressFieldState(
                  ...
                  onChanged: (String value) =>
                      widget.onChanged({...?widget.data, 'state': value}),
                  validator:
                      validatorInput(keyField, requiredInput!, translate),
                  states: states,
                  stateId: stateId,
            ...
            return Padding(
              ...
              child: AddressFieldText(
                ...
                borderFields: widget.borderFields,
                onChanged: (String value) =>
                    widget.onChanged({...?widget.data, keyField: value}),
              ),
            );
          }),
        ],
...
class _AddressFieldText extends State<AddressFieldText> {
  ...
  Widget build(BuildContext context) {
    TranslateType translate = AppLocalizations.of(context)!.translate;
    String? labelText =
        widget.requiredInput! ? '${widget.label} *' : widget.label;
    ...
    return TextFormField(
      ...
      validator: widget.requiredInput!
          ? (String? value) {
              ...
              if (widget.validate is List &&
                  widget.validate!.contains('email')) {
                return emailValidator(
                    value: value,
                    errorEmail: translate('validate_email_value'));
              }
              return null;
            }
          : null,
    ...
    InputDecoration decoration = borderFields == true
        ? InputDecoration(
            ...
            contentPadding: const EdgeInsetsDirectional.only(
                start: itemPaddingMedium, end: itemPaddingMedium),
            border: OutlineInputBorder(
              borderRadius: BorderRadius.circular(8),
            ),
          )
        ...
        decoration: decoration.copyWith(
          suffixIcon: Padding(
            padding: EdgeInsetsDirectional.only(
                end: borderFields == true ? itemPaddingMedium : 0),
