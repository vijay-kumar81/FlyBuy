  ...
  Widget buildItemView({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          color: theme.colorScheme.surface, borderRadius: borderRadius),
      child: Row(
        children: [
          Icon(
            icon,
          ...
          Expanded(
            child: FlybuyHtml(html: translate(name)),
          ),
        ],
      ),
    );
      ...
      body: FlybuyFixedBottom(
        ...
        child: SingleChildScrollView(
          padding: paddingHorizontal.copyWith(
              top: itemPadding, bottom: itemPaddingLarge),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(translate('delete_account_term_title'),
              ...
              ...List.generate(termData.length, (index) {
                ...
                double padBottom =
                    index < termData.length - 1 ? itemPaddingMedium : 0;
