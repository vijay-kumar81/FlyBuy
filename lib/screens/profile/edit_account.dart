...
import 'package:flybuy/utils/form_field_validator.dart';
...
class _EditAccountScreenState extends State<EditAccountScreen>
  ...
  Widget renderFirstName({required TranslateType translate}) {
    return TextFormField(
      ...
      decoration:
          InputDecoration(labelText: translate('edit_account_first_name')),
  ...
  Widget renderLastName({required TranslateType translate}) {
    return TextFormField(
      ...
      decoration:
          InputDecoration(labelText: translate('edit_account_last_name')),
      textInputAction: TextInputAction.next,
      onFieldSubmitted: (value) {
  ...
  Widget renderDisplayName({required TranslateType translate}) {
    return TextFormField(
      ...
      decoration:
          InputDecoration(labelText: translate('edit_account_display_name')),
      textInputAction: TextInputAction.next,
      onFieldSubmitted: (value) {
  ...
  Widget renderEmail({required TranslateType translate}) {
    return TextFormField(
      ...
      validator: (value) => emailValidator(
          value: value!, errorEmail: translate('validate_email_value')),
      keyboardType: TextInputType.emailAddress,
      decoration:
          InputDecoration(labelText: translate('edit_account_email_address')),
    );
  }
}
