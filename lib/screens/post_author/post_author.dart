...
class _PostAuthorScreenState extends State<PostAuthorScreen>
  ...
  void didChangeDependencies() {
    ...
    if (widget.args!['author'] != null &&
        widget.args!['author'].runtimeType == PostAuthor) {
  ...
  Future<void> getPostAuthor(int id) async {
    try {
      if (id != 0) {
        _postAuthor =
            await Provider.of<RequestHelper>(context).getPostAuthor(id: id);
      }
      setState(() {
        _loading = false;
      });
