...
class ForgotPassword extends StatelessWidget with AppBarMixin, SnackMixin {
  ...
  void onSubmit(BuildContext context,
      {String? email, required TranslateType translate}) async {
    try {
      success() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar:
          baseStyleAppBar(context, title: translate('forgot_password_appbar')),
      body: SafeArea(
        child: renderForm(
          child: Column(
            children: [
              Expanded(
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      Text(translate('forgot_password_description'),
                          ...
                          onPressed: !authStore!.forgotPasswordStore.loading
                              ? () {
                                  if (_formKey.currentState!.validate()) {
                                    ...
                                    onSubmit(context,
                                        email: email, translate: translate);
                                  }
                                }
                              : () {},
