...
import 'package:flybuy/screens/auth/widgets/verify_code.dart';
import 'package:flybuy/service/helpers/request_helper.dart';
import 'package:flybuy/store/auth/digits_store.dart';
import 'package:flybuy/widgets/flybuy_phone_input/phone_number.dart';
import 'package:flybuy/mixins/mixins.dart';
import 'package:flybuy/screens/home/home.dart';
...
class _LoginMobileDigitsState extends State<LoginMobileDigits>
  ...
  onSubmit({required PhoneNumber phoneNumber}) async {
    ...
    String? mobileNo = phoneNumber.number!.startsWith('+')
        ? phoneNumber.number!.replaceAll(countryCode, '')
        : phoneNumber.number;
              ...
              return StatefulBuilder(builder: (BuildContext context, setState) {
                return VerifyCode(
                  ...
                  onVerify: (smsCode) async {
                    try {
                      final dataVerifyOtp =
                          await _requestHelper.digitsVerifyOtp({
                        'type': widget.type,
                        'mobileNo': mobileNo,
                        'countrycode': countryCode,
                        'whatsapp': 0,
                      ...
                      setState(
                          () => checkOTP = dataVerifyOtp['code'].toString());
                      if (dataVerifyOtp['code'] == 1) {
                        await handleLoginAndRegister(
                            mobileNo: mobileNo!,
                            countryCode: countryCode,
                            otp: smsCode);
                      }
