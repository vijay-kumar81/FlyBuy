...
class _VendorListScreenState extends State<VendorListScreen>
  ...
  void didChangeDependencies() {
    ...
    WidgetConfig? widgetConfig =
        _settingStore!.data!.screens!['vendorList'] != null
            ? _settingStore!
                .data!.screens!['vendorList']!.widgets!['vendorListPage']
            : null;
    String lang = _settingStore?.locale ?? defaultLanguage;
    int itemPerPage = widgetConfig != null
        ? ConvertData.stringToInt(
            get(widgetConfig.fields, ['itemPerPage'], 10), 10)
        : 10;
  ...
  void _onScroll() {
    if (!_controller.hasClients ||
        _vendorStore!.loading ||
        !_vendorStore!.canLoadMore) return;
  ...
  Widget build(BuildContext context) {
    ...
    bool enableRangeFilter = widgetConfig != null
        ? get(widgetConfig.fields, ['enableRangeFilter'], false)
        : false;
    ...
    return Observer(builder: (_) {
      ...
      List<Vendor> emptyVendor =
          List.generate(_vendorStore!.perPage, (index) => Vendor());
      ...
      if (_vendorStore!.vendors.isEmpty && !loading) {
        return Scaffold(
          ...
          appBar: AppBar(
            title: Text(translate('vendor_list_txt'),
  ...
  Widget buildHeader(
      BuildContext context, VendorStore? vendorStore, bool enableRangeFilter) {
    TranslateType translate = AppLocalizations.of(context)!.translate;
              ...
              showModalBottomSheet(
                ...
                builder: (context) {
                  ...
                  return Refine(
                    ...
                    onSubmit: (String search, double? rangeDistance,
