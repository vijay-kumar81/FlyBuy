...
class Refine extends StatefulWidget {
  ...
  final Function(String search, double? rangeDistance,
      List<ProductCategory>? categories)? onSubmit;
                  ...
                  child: ListView(
                    children: [
                      ...
                      if (widget.enableRange) ...[
                        ...
                        Text(translate('vendor_refine_range'),
                            style: theme.textTheme.titleSmall),
                        Row(
                          children: [
                            Text(translate(
                                'vendor_refine_distance', {'distance': '0'})),
                            Expanded(
                              child: Slider(
                            ...
                            Text(translate(
                                'vendor_refine_distance', {'distance': '100'})),
                          ],
                        ),
                      ],
                      FlybuyTile(
                        ...
                        ...List.generate(categories.length, (index) {
                          ...
                          return Padding(
                            ...
                            child: _ItemCategory(
                              ...
                              onChange:
                                  (ProductCategory value, bool isSelect) =>
                                      setState(() {
                                if (!isSelect) {
                                  _categories = [
                                    ...?_categories,
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () => widget.onSubmit!(
                          _txtSearch!.text, _rangeDistance, _categories),
                    ),
                  ),
                )
              ],
...
class _ItemCategoryState extends State<_ItemCategory> {
  ...
  Widget build(BuildContext context) {
    ...
    bool isSelect = widget.selectCategories
