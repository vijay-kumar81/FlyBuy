...
class _LayoutMapState extends State<LayoutMap> with LoadingMixin {
                                ...
                                if (widget.loading!)
                                  SliverToBoxAdapter(
                                    child: buildLoading(context,
                                        isLoading:
                                            widget.vendorStore!.canLoadMore),
                                  ),
                              ],
                            ),
                          ),
  ...
  Widget builderView(BuildContext context,
      {List<Vendor>? vendors, String? view, int? type}) {
    ThemeData theme = Theme.of(context);
  ...
  Widget buildItem(
    ...
    return FlybuyVendorItem(
      ...
      widthBanner: widthBanner,
      heightBanner: heightBanner,
      directionIcon: vendor != null && vendor.location != null
          ? buildIconDirection(context, vendor: vendor)
          : null,
      enableDistance: true,
    );
  }
  ...
  Widget buildIconDirection(BuildContext context, {Vendor? vendor}) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child:
            Icon(FeatherIcons.navigation, color: theme.primaryColor, size: 14),
      ),
    );
  }
}
