...
mixin ChatService<T extends StatefulWidget> on State<T> {
  ...
  subscribeChatMessages({
    ...
    Stream<DatabaseEvent> stream = chatMessagesRef
  ...
  void subscribeEndChat({
    ...
    Stream<DatabaseEvent> stream =
        chatSessionsRef.orderByKey().equalTo(conversationId).onChildRemoved;
  ...
  void subscribeTyping({
    ...
    Stream<DatabaseEvent> stream =
        database.ref("chat_sessions/$conversationId/typing").onChildAdded;
    Stream<DatabaseEvent> stream2 =
        database.ref("chat_sessions/$conversationId/typing").onChildRemoved;
