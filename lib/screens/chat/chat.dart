...
import 'package:flybuy/screens/chat/services/chat_service.dart';
import 'package:flybuy/store/store.dart';
import 'package:flybuy/themes/default/chat/chat_appbar.dart';
import 'package:flybuy/themes/default/chat/chat_messages.dart';
...
class _ChatDetailScreenState extends State<ChatDetailScreen>
    with AppBarMixin, NavigationMixin, ChatService {
  ...
  void _onTyping(String type) {
    List<flutter_chat_types.Message> messages =
        List<flutter_chat_types.Message>.of(_messages);
    ...
    if (type == 'deleted' &&
        messages.isNotEmpty &&
        messages.first is flutter_chat_types.CustomMessage) {
      messages.removeAt(0);
    }
  ...
  Widget _buildMessages() {
    return ChatMessages(
        data: _messages, userId: _userId, handleChat: _handleChat);
  }
}
