...
class AboutWidget extends StatelessWidget with Utility {
  ...
  Widget buildItemAddress(BuildContext context,
  ...
  Widget buildAddress(BuildContext context) {
    return Column(
      children: [
        buildItemAddress(context,
            icon: FeatherIcons.phoneForwarded, title: vendor!.phone ?? ''),
        if (vendor!.showEmail! &&
            vendor!.email is String &&
            vendor!.email!.isNotEmpty) ...[
          const SizedBox(height: 8),
          buildItemAddress(context,
              icon: FeatherIcons.mail, title: vendor!.email!),
        ],
        const SizedBox(height: 8),
        buildItemAddress(context,
            icon: FeatherIcons.mapPin, title: vendor!.vendorAddress ?? ''),
      ],
    );
  }
  ...
  Widget buildSocial(BuildContext context) {
    String? linkFacebook =
        vendor!.social is Map ? get(vendor!.social, ['fb'], '') : '';
    String? linkGplus =
        vendor!.social is Map ? get(vendor!.social, ['gplus'], '') : '';
    String? linkTwitter =
        vendor!.social is Map ? get(vendor!.social, ['twitter'], '') : '';
    String? linkInstagram =
        vendor!.social is Map ? get(vendor!.social, ['instagram'], '') : '';
    String? linkYoutube =
        vendor!.social is Map ? get(vendor!.social, ['youtube'], '') : '';
    String? linkLinkedin =
        vendor!.social is Map ? get(vendor!.social, ['linkedin'], '') : '';
    String? linkSnapchat =
        vendor!.social is Map ? get(vendor!.social, ['snapchat'], '') : '';
    String? linkPinterest =
        vendor!.social is Map ? get(vendor!.social, ['pinterest'], '') : '';
    if (linkFacebook == '' &&
        linkGplus == '' &&
        linkTwitter == '' &&
        linkInstagram == '' &&
    ...
    return Wrap(
      ...
      children: [
        ...
        if (linkInstagram != '')
          FlybuyButtonSocial.instagram(
            size: 34,
            sizeIcon: 14,
            boxFit: SocialBoxFit.outline,
            type: SocialType.square,
            onPressed: () =>
                share(linkInstagram!, 'https://www.instagram.com/'),
          ),
        if (linkYoutube != '')
          FlybuyButtonSocial.youtube(
            size: 34,
            sizeIcon: 14,
            boxFit: SocialBoxFit.outline,
            type: SocialType.square,
        ...
        if (linkPinterest != '')
          FlybuyButtonSocial.pinterest(
            size: 34,
            sizeIcon: 14,
            boxFit: SocialBoxFit.outline,
            type: SocialType.square,
            onPressed: () =>
                share(linkPinterest!, 'https://www.pinterest.com/'),
          ),
      ],
    );
  }
