...
import 'package:flybuy/screens/product_list/data.dart';
import 'package:flybuy/screens/product_list/widgets/filter_list.dart';
import 'package:flybuy/screens/product_list/widgets/heading_list.dart';
import 'package:flybuy/screens/product_list/widgets/product_list.dart';
import 'package:flybuy/screens/product_list/widgets/refine.dart';
import 'package:flybuy/screens/vendor/vendor_info.dart';
...
class _VendorScreenState extends State<VendorScreen>
    with AppBarMixin, LoadingMixin, NavigationMixin {
  Vendor? _vendor;
  bool _loading = true;
  ...
  void didChangeDependencies() {
    Vendor? vendor =
        widget.args!['vendor'] is Vendor ? widget.args!['vendor'] : Vendor();
...
class VendorDataScreen extends StatefulWidget {
  const VendorDataScreen({Key? key, required this.vendor, this.store})
      : super(key: key);
...
class _VendorDataScreenState extends State<VendorDataScreen>
  ...
  void initState() {
    ...
    _filterStore = FilterStore(widget.store!.requestHelper,
        language: widget.store!.locale);
  ...
  Widget build(BuildContext context) {
    ...
    WidgetConfig? widgetConfig =
        widget.store!.data!.screens!['vendorDetail'] != null
            ? widget.store!.data!.screens!['vendorDetail']!
                .widgets!['vendorDetailPage']
            : null;
    ...
    bool enableRating = widgetConfig != null
        ? get(widgetConfig.fields, ['enableRating'], true)
        : true;
        ...
        return [
          ...
          if (layouts.isNotEmpty) ...[
            ...
            if (loading)
              SliverToBoxAdapter(
                child:
                    buildLoading(context, isLoading: productStore.canLoadMore),
              ),
          ]
        ];
    }
