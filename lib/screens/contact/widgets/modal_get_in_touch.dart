...
class _ModalGetInTouchState extends State<ModalGetInTouch>
    with SnackMixin, LoadingMixin {
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                      contentPadding: const EdgeInsetsDirectional.only(
                          start: itemPaddingMedium, top: itemPaddingMedium),
                  ...
                  child: ElevatedButton(
                      onPressed: () async {
                        if (_formKey.currentState!.validate()) {
                          ...
                          try {
                            Map<String, dynamic> res = await requestHelper
                                .sendContact(queryParameters: {
