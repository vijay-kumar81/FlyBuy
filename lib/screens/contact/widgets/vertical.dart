...
class _VerticalContact extends State<VerticalContact>
    with Utility, AppBarMixin {
  double top = 0.7;
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: List.generate(widget.items.length, (index) {
                          ...
                          // info
                          String heading = get(item,
                              ['data', 'titleHeading', widget.languageKey], '');

                          EdgeInsetsDirectional padding =
                              EdgeInsetsDirectional.only(
                                  bottom: index < count - 1 ? 40 : 0);
