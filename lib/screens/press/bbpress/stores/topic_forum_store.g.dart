...
mixin _$BBPTopicForumStore on BBPTopicForumStoreBase, Store {
  ...
  @override
  BBPForum? get forum =>
      (_$forumComputed ??= Computed<BBPForum?>(() => super.forum,
              name: 'BBPTopicForumStoreBase.forum'))
          .value;
  Computed<bool>? _$enableUpdateForumComputed;

  @override
  bool get enableUpdateForum => (_$enableUpdateForumComputed ??= Computed<bool>(
          () => super.enableUpdateForum,
          name: 'BBPTopicForumStoreBase.enableUpdateForum'))
      .value;
  Computed<bool>? _$loadingComputed;

  @override
  bool get loading => (_$loadingComputed ??= Computed<bool>(() => super.loading,
          name: 'BBPTopicForumStoreBase.loading'))
      .value;
  ...
  int get nextPage =>
      (_$nextPageComputed ??= Computed<int>(() => super.nextPage,
              name: 'BBPTopicForumStoreBase.nextPage'))
          .value;
  ...
  ObservableList<BBPTopic> get topics => (_$topicsComputed ??=
          Computed<ObservableList<BBPTopic>>(() => super.topics,
              name: 'BBPTopicForumStoreBase.topics'))
      .value;
  ...
  bool get canLoadMore =>
      (_$canLoadMoreComputed ??= Computed<bool>(() => super.canLoadMore,
              name: 'BBPTopicForumStoreBase.canLoadMore'))
          .value;
  Computed<int>? _$perPageComputed;

  @override
  int get perPage => (_$perPageComputed ??= Computed<int>(() => super.perPage,
          name: 'BBPTopicForumStoreBase.perPage'))
      .value;

  late final _$_forumAtom =
      Atom(name: 'BBPTopicForumStoreBase._forum', context: context);
  ...
  late final _$_enableUpdateForumAtom =
      Atom(name: 'BBPTopicForumStoreBase._enableUpdateForum', context: context);
  ...
  late final _$fetchTopicsFutureAtom =
      Atom(name: 'BBPTopicForumStoreBase.fetchTopicsFuture', context: context);
  ...
  late final _$_topicsAtom =
      Atom(name: 'BBPTopicForumStoreBase._topics', context: context);
  ...
  late final _$_perPageAtom =
      Atom(name: 'BBPTopicForumStoreBase._perPage', context: context);
  ...
  late final _$_nextPageAtom =
      Atom(name: 'BBPTopicForumStoreBase._nextPage', context: context);
  ...
  late final _$_canLoadMoreAtom =
      Atom(name: 'BBPTopicForumStoreBase._canLoadMore', context: context);
  ...
  late final _$pendingAtom =
      Atom(name: 'BBPTopicForumStoreBase.pending', context: context);
  ...
  late final _$getTopicsAsyncAction =
      AsyncAction('BBPTopicForumStoreBase.getTopics', context: context);
  ...
  @override
  Future<void> refresh() {
    final _$actionInfo = _$BBPTopicForumStoreBaseActionController.startAction(
        name: 'BBPTopicForumStoreBase.refresh');
    try {
  ...
  Future<void> initQuery() {
    final _$actionInfo = _$BBPTopicForumStoreBaseActionController.startAction(
        name: 'BBPTopicForumStoreBase.initQuery');
    try {
