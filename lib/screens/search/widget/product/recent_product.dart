...
class RecentSearch extends StatefulWidget {
  final String? search;
  final List<SuggestionPost>? data;
  ...
  Widget build(BuildContext context) {
    ...
    return Observer(
      builder: (_) {
        ...
        List<dynamic> dataRecent = widget.searchStore!.data
          ...
          children: [
            Padding(
                padding: const EdgeInsetsDirectional.only(
                    start: 16, top: 24, end: 16),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text(translate('search_recent'),
                        style: Theme.of(context).textTheme.titleLarge),
                    InkWell(
                      onTap: () {
                        widget.searchStore!.removeAllSearch();
                      },
                      child: Text(translate('search_clear_all'),
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    ...
                    trailing: InkWell(
                      onTap: () {
                        widget.searchStore!
                            .removeSearch(dataRecent.elementAt(index)['title']);
                      },
