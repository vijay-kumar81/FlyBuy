  ...
  Widget build(BuildContext context) {
    ...
    return Observer(
      ...
      builder: (context) {
        ...
        List<Post> loadingProduct =
            List.generate(_postStore.perPage, (index) => Post()).toList();
          ...
          return CustomScrollView(
            ...
            slivers: [
              ...
              if (loading)
                SliverToBoxAdapter(
                  child:
                      buildLoading(context, isLoading: _postStore.canLoadMore),
                ),
            ],
          );
        }
        ...
        return NotificationScreen(
          title: Text(translate('post_search_results'),
