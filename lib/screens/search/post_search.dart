...
import 'package:flybuy/screens/search/widget/post/result_post.dart';
import 'package:flybuy/screens/search/widget/post/search_post.dart';
...
class PostSearchDelegate extends SearchDelegate<String?> {
  ...
  ThemeData appBarTheme(BuildContext context) {
    ...
    return theme.copyWith(
      ...
      textTheme: query != ''
          ? textTheme.copyWith(titleLarge: textTheme.titleSmall)
          : null,
    );
  }
