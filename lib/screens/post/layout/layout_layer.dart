...
import 'package:flybuy/screens/post/widgets/post_action.dart';
import 'package:flybuy/screens/post/widgets/post_image.dart';
...
class LayoutLayer extends StatelessWidget with AppBarMixin {
  ...
  Widget build(BuildContext context) {
    List rowHeader = rows != null
        ? rows!
            .where((e) => get(e, ['data', 'visit'], 'content') == 'header')
            .toList()
        : [];
    List rowContent = rows != null
        ? rows!
            .where((e) => get(e, ['data', 'visit'], 'content') != 'header')
            .toList()
        : [];

    Map<String, dynamic>? rowHeaderFirst =
        rowHeader.isNotEmpty ? rowHeader[0] : null;
