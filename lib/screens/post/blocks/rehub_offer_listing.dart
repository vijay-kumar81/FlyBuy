  ...
  Widget build(BuildContext context) {
    ...
    List offers = get(attrs, [
    ...
    ], [
      {
        ...
        "oldPrice": "",
        "button": {
          "text": translate('post_detail_offerbox_button'),
          "url": "",
          "newTab": false,
          "noFollow": false
        },
        ...
        return ListView.separated(
          ...
          itemBuilder: (_, int index) {
            ...
            Color? backgroundBadge = ConvertData.fromHex(
                get(item, ['customBadge', 'backgroundColor'], '#77b21d'),
                ColorBlock.greenBase2);
            Color? colorBadge = ConvertData.fromHex(
                get(item, ['customBadge', 'textColor'], '#fff'), Colors.white);
            String coupon = get(attrs, ['coupon'], '');
            bool? maskCoupon = get(attrs, ['maskCoupon'], false);
            String? textButton = get(item, ['button', 'text'],
                translate('post_detail_offerbox_button'));
            String? urlButton = get(attrs, ['button', 'url'], '');
            String? maskCouponText = get(attrs, ['maskCouponText'],
                translate('post_detail_offerbox_reveal'));
