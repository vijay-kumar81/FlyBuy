...
import 'package:flybuy/utils/string_generate.dart';
...
class BlockImage extends StatelessWidget {
  ...
  Widget buildItem(BuildContext context,
      {required String url, required String tag, required Widget child}) {
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(builder: (_, BoxConstraints constraints) {
      ...
      double width =
          ConvertData.stringToDouble(image.attributes['width'], screenWidth);
      double? height =
          ConvertData.stringToDouble(image.attributes['height'], screenWidth);
      ...
      return buildItem(
        ...
        child: Hero(
            tag: tag,
            child: FlybuyCacheImage(url, width: width, height: height)),
      );
    });
  }
}
