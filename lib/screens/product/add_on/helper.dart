...
String getTextDuration(BuildContext context,
    {required Map option, required TranslateType translate}) {
...
double getAddonPriceAppointment(
...
double getAddonDurationAppointment(
    {required Map<String, AddOnData> data, required int qty}) {
  double result = 0;
