...
import 'package:flybuy/screens/product/widgets/product_appointment/appointment_helper.dart';
import 'package:flybuy/screens/product/widgets/product_appointment/calendar_header.dart';
import 'package:flybuy/screens/product/widgets/product_appointment/list_time_stamp.dart';
import 'package:flybuy/screens/product/widgets/product_appointment/menu_staff.dart';
        ...
        if (staffAssignment == 'customer') {
          ...
          if (staffs.isNotEmpty) {
            for (var staff in staffs) {
              ...
              dynamic productStaff = products.firstWhereOrNull((element) =>
              ...
              if (products.firstWhereOrNull((element) =>
                  ...
                  null) {
                _listStaff.add(
                    StaffModel(id: idStaff, name: nameStaff, price: price));
              }
            }
            if (staffNopref) {
              if (mounted) {
