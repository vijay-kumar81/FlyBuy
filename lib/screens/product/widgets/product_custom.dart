...
class ProductCustom extends StatelessWidget with Utility, NavigationMixin {
  ...
  const ProductCustom({Key? key, required this.configs, this.align = 'left'})
      : super(key: key);
  ...
  Widget _buildLayer(BuildContext context,
      {required ProductDetailValue configs, required double widthView}) {
    ...
    if (configs.customType == 'button') {
      Map<String, dynamic>? buttonBg =
          get(configs.buttonBg, [themeModeKey], null);
      Map<String, dynamic>? buttonBorderColor =
          get(configs.buttonBorderColor, [themeModeKey], null);
      ...
      child = Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.all(
              Radius.circular(configs.buttonBorderRadius ?? 0)),
          border: Border.all(
              color:
    ...
    if (configs.customType == 'icon') {
      ...
      Map<String, dynamic>? iconColor =
          get(configs.iconColor, [themeModeKey], null);
