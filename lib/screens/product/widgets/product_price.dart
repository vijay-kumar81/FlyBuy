...
class ProductPrice extends StatelessWidget with ProductMixin {
  ...
  const ProductPrice(
      {Key? key, this.product, this.align = 'left', this.pad = 17})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    Color subTextColor = ConvertData.fromRGBA(
        get(widgetConfig.styles, ['subTextColor', themeModeKey], {}),
        theme.textTheme.bodySmall!.color);
    Color priceColor = ConvertData.fromRGBA(
        get(widgetConfig.styles, ['priceColor', themeModeKey], {}),
        theme.textTheme.titleMedium!.color);
    Color salePriceColor = ConvertData.fromRGBA(
        get(widgetConfig.styles, ['salePriceColor', themeModeKey], {}),
        ColorBlock.red);
    Color regularPriceColor = ConvertData.fromRGBA(
        get(widgetConfig.styles, ['regularPriceColor', themeModeKey], {}),
        theme.textTheme.bodySmall!.color);
    ...
    return Container(
      ...
      child: buildPrice(
        context,
        product: product!,
        regularStyle: theme.textTheme.titleMedium
            ?.copyWith(fontWeight: FontWeight.normal, color: regularPriceColor),
        ...
        styleFrom: theme.textTheme.bodyLarge
            ?.copyWith(fontWeight: FontWeight.normal, color: subTextColor),
