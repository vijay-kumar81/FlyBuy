  ...
  Widget build(BuildContext context) {
    ...
    if (product!.type == productTypeBooking) {
      return ProductWooBooking(
        ...
        productId: product!.id.toString(),
        getSlots:
            Provider.of<SettingStore>(context).requestHelper.getActiveHours,
        getBookingProduct: Provider.of<SettingStore>(context)
            .requestHelper
            .getAppointmentProduct,
        getBookableDays:
            Provider.of<SettingStore>(context).requestHelper.getBookableDays,
      );
    }
