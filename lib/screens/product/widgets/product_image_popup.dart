...
import 'package:flybuy/widgets/flybuy_video.dart';
...
class ProductImagesPopup extends StatefulWidget {
  ...
  const ProductImagesPopup({Key? key, this.images, this.arguments})
      : super(key: key);
...
class ProductVideo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (type == 'vimeo' || type == 'custom') {
      return FlybuyVideoPlay(url: video, autoPlay: autoPlay);
    }
      ...
      return FittedBox(
        ...
        child: Transform.scale(
          ...
          child: SizedBox(
            ...
            child: Html(
              data:
                  '<iframe width="$widthVideo" height="$heightVideo" src="$videoUrl"></iframe>',
