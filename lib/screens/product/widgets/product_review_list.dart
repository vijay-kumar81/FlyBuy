...
class ProductReviewList extends StatefulWidget {
  ...
  const ProductReviewList({Key? key, this.product, this.store})
      : super(key: key);
...
class _ProductReviewListState extends State<ProductReviewList>
  ...
  Widget build(BuildContext context) {
    ...
    return Observer(builder: (_) {
      ...
      List<ProductReview> emptyReviews =
          List.generate(limit, (index) => ProductReview()).toList();
        ...
        body: CustomScrollView(
          ...
          slivers: [
            SliverAppBar(
              ...
              floating: true,
              pinned: true,
              title: Text(translate('product_reviews'),
              ...
              sliver: SliverList(
                delegate: SliverChildBuilderDelegate(
                  (BuildContext context, int index) {
                    return FlybuyReviewProductItem(review: data[index]);
                  },
              ...
              children: [
                Container(
                  ...
                  child: buildImage(context,
                      product: product!, width: 50, height: 60),
                ),
            ...
            children: [
              Column(
                children: [
                  ...
                  Text(
                    ratingCount > 1
                        ? translate('product_count_reviews',
                            {'count': ratingCount.toString()})
                        : translate('product_count_review',
                            {'count': ratingCount.toString()}),
                    style: theme.textTheme.bodySmall,
                  ),
                  FlybuyRating(value: valueRating),
                ],
              ),
