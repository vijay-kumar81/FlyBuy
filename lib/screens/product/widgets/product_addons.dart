          ...
          ? Column(
              children: List.generate(
                ...
                (index) {
                  ...
                  String fieldName = getFieldAddOn(item);
                  double padBottom = index < metaData['value'].length - 1
                      ? itemPaddingMedium
                      : 0;
                  return Padding(
...
class _Field extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    bool wcAppointmentHidePriceLabel =
        get(item, ['wc_appointment_hide_price_label'], 0) == 1;

    bool showDuration =
        get(item, ['wc_appointment_hide_duration_label'], 0) == 0;
      ...
      children: [
        if (labelType != 'hide') ...[
          LabelField(
            ...
            textDuration: showDuration
                ? getTextDuration(context, option: item, translate: translate)
                : null,
            type: labelType,
            require: require,
          ),
