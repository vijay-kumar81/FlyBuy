...
import 'package:flybuy/utils/currency_format.dart';
          ...
          children: [
            ProductCartItem(
              name: Row(
                ...
                children: [
                  Flexible(child: FlybuyHtml(html: name)),
                  ...
                  ...List.generate(
                    ...
                    (index) {
                      Map<String, dynamic> metaData =
                          widget.productData!.metaData!.elementAt(index);
                      ...
                      return TableRow(
                        children: [
                          Container(
                            constraints:
                                BoxConstraints(maxWidth: widthView / 2),
