...
abstract class PostStoreBase with Store {
  ...
  PostStoreBase(
    ...
    if (categories != null)
      _categorySelected = ObservableList<PostCategory>.of(categories);
  ...
  @observable
  ObservableList<PostCategory?> _categorySelected =
  ...
  Future<List<Post>> getPosts() async {
    ...
    final future = _requestHelper.getPosts(
        queryParameters: preQueryParameters(qs), postType: _postType);
  ...
  @action
  Future<List<SuggestionPost>?> suggestion(
      {Map<String, dynamic>? queryParameters, CancelToken? cancelToken}) async {
    List<SuggestionPost>? data = await _requestHelper.sugggestionPost(
      queryParameters: queryParameters,
      cancelToken: cancelToken,
    );
    return data;
  ...
  void onChanged(
    ...
    if (categorySelected != null)
      _categorySelected = ObservableList<PostCategory?>.of(categorySelected);
    if (tagSelected != null)
      _tagSelected = ObservableList<PostTag?>.of(tagSelected);
