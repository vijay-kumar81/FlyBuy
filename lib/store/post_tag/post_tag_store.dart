import 'package:flybuy/models/post_tag/post_tag.dart';
...
abstract class PostTagStoreBase with Store {
  ...
  // constructor:---------------------------------------------------------------
  PostTagStoreBase(this._requestHelper,
  ...
  // store variables:-----------------------------------------------------------
  static ObservableFuture<List<PostTag>> emptyPostTagResponse =
  ...
  Future<void> getPostTags() async {
    ...
    final future =
        _requestHelper.getPostTags(queryParameters: preQueryParameters(qs));
