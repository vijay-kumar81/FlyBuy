...
abstract class ProductReviewStoreBase with Store {
  ...
  // Store variables: --------------------------------------------------------------------------------------------------
  static ObservableFuture<List<ProductReview>> emptyProductReviewResponse =
      ObservableFuture.value([]);

  @observable
  ObservableFuture<List<ProductReview>?> fetchReviewsFuture =
      emptyProductReviewResponse;
  ...
  Future<List<ProductReview>> getReviews() async {
    ...
    final future =
        _requestHelper.getReviews(queryParameters: preQueryParameters(qs));
  ...
  Future<ProductReview> writeReview({Map<String, dynamic>? data}) async {
    ...
    return _requestHelper.writeReviews(
  ...
  Future<RatingCount> getRatingCount(
    ...
    RatingCount ratingCount =
        await _requestHelper.getRatingCount(queryParameters: queryParameters);
