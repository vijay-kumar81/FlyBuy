...
abstract class DownloadStoreBase with Store {
  ...
  // constructor:---------------------------------------------------------------
  DownloadStoreBase(this._requestHelper,
      {int? userId, int? perPage, String? lang, this.key}) {
  ...
  // store variables:-----------------------------------------------------------
  static ObservableFuture<List<Download>> emptyDownloadResponse =
      ObservableFuture.value([]);

  @observable
  ObservableFuture<List<Download>?> fetchDownloadsFuture =
      emptyDownloadResponse;
  ...
  Future<void> getDownloads() async {
    ...
    final future = _requestHelper.getDownloads(
        userId: _userId, queryParameters: preQueryParameters(qs));
