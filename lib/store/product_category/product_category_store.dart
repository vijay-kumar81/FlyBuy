...
import 'package:flybuy/constants/app.dart' as app_configs;
...
class ProductCategoryStore = ProductCategoryStoreBase
    with _$ProductCategoryStore;
...
abstract class ProductCategoryStoreBase with Store {
  ...
  Future<void> getCategories() async {
    try {
      ...
      List<dynamic> data = await _requestHelper.getProductCategories(
