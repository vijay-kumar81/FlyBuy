import 'package:flybuy/models/post/post_archive.dart';
...
abstract class PostArchiveStoreBase with Store {
  ...
  // store variables:-----------------------------------------------------------
  static ObservableFuture<List<PostArchive>> emptyPostArchiveResponse =
      ObservableFuture.value([]);

  @observable
  ObservableFuture<List<PostArchive>?> fetchPostArchivesFuture =
      emptyPostArchiveResponse;

  @observable
  ObservableList<PostArchive> _postArchives =
      ObservableList<PostArchive>.of([]);
