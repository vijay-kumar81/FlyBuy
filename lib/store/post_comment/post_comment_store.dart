...
abstract class PostCommentStoreBase with Store {
  ...
  // store variables:-----------------------------------------------------------
  static ObservableFuture<List<PostComment>> emptyPostCommentResponse =
      ObservableFuture.value([]);

  @observable
  ObservableFuture<List<PostComment>?> fetchPostCommentsFuture =
      emptyPostCommentResponse;

  @observable
  ObservableList<PostComment> _postComments =
      ObservableList<PostComment>.of([]);
  ...
  Future<void> getPostComments() async {
    ...
    final future = _requestHelper!
        .getPostComments(queryParameters: preQueryParameters(qs));
  ...
  Future<PostComment> writeComment({
    ...
    try {
      PostComment comment =
          await _requestHelper!.writeComments(queryParameters: data);
      return comment;
    } on DioException {
      rethrow;
    }
