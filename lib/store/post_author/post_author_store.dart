...
abstract class PostAuthorStoreBase with Store {
  ...
  // store variables:-----------------------------------------------------------
  static ObservableFuture<List<PostAuthor>> emptyPostAuthorResponse =
      ObservableFuture.value([]);

  @observable
  ObservableFuture<List<PostAuthor>?> fetchPostAuthorsFuture =
      emptyPostAuthorResponse;
  ...
  Future<void> getPostAuthors() async {
    ...
    final future =
        _requestHelper.getPostAuthors(queryParameters: preQueryParameters(qs));
