...
String? b2bkingFilterPrice(
    BuildContext context, String? price, Product product, String type) {
  ...
  if (userOptions == null ||
      userOptions.b2bkingCustomerGroupId == '' ||
      data == null) {
    return price;
  }
  ...
  Map<String, dynamic> metaData = data.firstWhere(
    (e) =>
        e['key'] ==
        'b2bking_${type}_product_price_group_${userOptions.b2bkingCustomerGroupId}',
    orElse: () => {'value': ''},
  );
